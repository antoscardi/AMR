...
% Controller state
xhi_history = zeros(3, Nstep); xhi_history(:,1) = [initialVelocity;initialVelocity;initialVelocity];
% Error
...
plot_function(q_history,'State variation in time','x [m] ; y [m] ; theta [rad]', timeVec, linewidth, colors, counter) 
% Plot input (vector u).
