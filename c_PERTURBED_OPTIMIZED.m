...
plot_function(q_NOPT_PERT, 'Comparison between NOT OPTIMAL and OPTIMAL state evolution in the perturbed case', 'X[m];Y[m];THETA[rad]', timeVec, linewidth, colors, counter)
% Plot input (vector u).
