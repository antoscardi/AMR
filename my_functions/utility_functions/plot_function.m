function plot_function(data, title_name, main_label,labels_names, lineNames, stackedtitle,timeVec, linewidth, colors,f)
    ...
    legend(splittedLabels{1},'zero line','FontSize',stackedfont)
    ylim([yMin13 yMax13])
    nexttile
    ...
    xlabel('time [s]','FontSize',font)
    legend(splittedLabels{2},'zero line','FontSize',stackedfont)
    ylim([yMin13 yMax13])
    ...
    nexttile
        ...
        xlabel('time [s]','FontSize',font)
        legend(splittedLabels{3},'zero line','FontSize',stackedfont)
        ylim([yMin13 yMax13])
    ...
    nexttile
        ...
        legend(splittedLabels{4},'zero line','FontSize',stackedfont)
        xlabel('time [s]','FontSize',font)
